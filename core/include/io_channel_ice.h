...
class SendDataException : public ::Ice::UserExceptionHelper<SendDataException, ::Ice::UserException>
{
public:

    virtual ~SendDataException();

    SendDataException(const SendDataException&) = default;

    SendDataException() = default;
...
/// \cond INTERNAL
static SendDataException _iceS_SendDataException_init;
/// \endcond
...
public:
    ...
    virtual void sendAsync(::std::string nodeid, ::std::string msgid, bytes data, ::std::function<void(int returnValue)> response, ::std::function<void(::std::exception_ptr)> exception, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
class SendDataException : public ::Ice::UserException
{
public:
    ...
    virtual ~SendDataException();
#else
    virtual ~SendDataException() throw();
#endif
     ...
     */
    virtual SendDataException* ice_clone() const;
    /**
...
/**
 * AMD callback class for ChannelSdk::IoChannel::send_async.
 * Call the ice_response method for a successful completion, or the ice_exception
 * method in the case of an error.
 */
class AMD_IoChannel_send : public virtual ::Ice::AMDCallback
{
public:

    virtual ~AMD_IoChannel_send();
...
typedef ::IceUtil::Handle< ::ChannelSdk::AMD_IoChannel_send> AMD_IoChannel_sendPtr;
...
class AMD_IoChannel_send : public ::ChannelSdk::AMD_IoChannel_send, public ::IceInternal::IncomingAsync
{
public:

    AMD_IoChannel_send(::IceInternal::Incoming&);
...
public:
    ...
    virtual void send_async(const ::ChannelSdk::AMD_IoChannel_sendPtr& cb, const ::std::string& nodeid, const ::std::string& msgid, const bytes& data, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_send(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
