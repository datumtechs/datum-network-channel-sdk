...
const string C_EVENT_CODE_NO_PUBLIC_IP = "0402000";
const string C_EVENT_CODE_NO_GLACIER2 = "0402001";
const string C_EVENT_CODE_NO_ICEGRID = "0402002";
const string C_EVENT_CODE_INVALID_CERT = "0402003";
const string C_EVENT_CODE_START_SERVICE = "0402004";
const string C_EVENT_CODE_CREATE_CLIENT = "0402005";
const string C_EVENT_CODE_INVALID_PROXY = "0402006";
const string C_EVENT_CODE_CONNECT_TIMEOUT = "0402007";
const string C_EVENT_CODE_SEND_DATA_TIMEOUT = "0402008";
...
static void HANDLE_EXCEPTION_EVENT(const string& strEventCode, const string& taskid, ...) {
    ...
    // Event Struct
    char* pEventInfo = "{\"type\":\"%s\", \"taskId\":\"%s\", \"content\":\"%s\", \"createTime\":\"%s\"}";
    // Get Current Time
    time_t t = time(0); 
    char timeTmp[32]={NULL};
